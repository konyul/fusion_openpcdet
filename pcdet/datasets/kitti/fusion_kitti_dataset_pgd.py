...
class FusionKittiDataset_PGD(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.class_id = ['Pedestrian','Cyclist','Car']
    ...
    def get_image(self, idx):
        ...
        img_bytes = file_client.get(img_file)
        image = mmcv.imfrombytes(img_bytes, flag='color')
    ...
    def __getitem__(self, index):
        ...
        if 'annos' in info:
            ...
            if "gt_boxes2d" in get_item_list:
                input_dict['gt_boxes2d'] = td_gt_boxes
        ...
        if "images" in get_item_list:
            ...
            # input_dict['orig_images'] = self.get_image(sample_idx)
        ...
        if "calib_matricies" in get_item_list:
            ...
            input_dict['lidar2img'] = kitti_utils.calib_to_matriciesv2(calib)
        ...
        for key, val in data_dict.items():
            try:
                if key in ['voxels', 'voxel_num_points']:
                    ...
                    ret[key] = val
                elif key in ['gt_boxes', 'gt_boxes_no3daug', 'gt_boxes2d']:
